...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        ...
        <p class="text-center mt-3">
            Discover our range of luxurious rooms designed for your comfort and relaxation.<br>
            Whether you're traveling for business or leisure, we have the perfect accommodation to suit your needs.<br>
            Each room is equipped with modern amenities and offers stunning views of the city.
                    ...
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 rounded mb-3 ">
                                ...
                                <div class="mb-2">
                                    <input type="checkbox" class="form-check-input">
                                    <label class="form-label">Gym Access</label>
                                </div>
                            </div>
                            <div class="border bg-light p-3 rounded mb-3 ">
                ...
                <div class="card mb-4 border-0 shadow">
                    <div class="row g-0 p-3 align-items-center">
                        ...
                        <div class="col-md-2 mt-lg-0 mt-md-0 mt-3 text-center">
                            <h6 class="mb-4"> 1tr9 VNĐ/night</h6>
